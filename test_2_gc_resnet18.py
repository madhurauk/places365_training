...
def validate(val_loader, model, criterion):
    ...
    acc.per_class_accuracy(
        pred_stack, target_stack, calculate_per_class_acc, calculate_overall_acc=False, num_classes=365, resume_model_path=args.resume, save_path='models/resnet18/accuracy/'
    )
    ...
    #     # pdb.set_trace()
    # torch.save(res, 'models/resnet18/accuracy/overall/top'+str(topk[0])+'_top'+str(topk[1])+'_accuracy_epoch'+args.resume.split("_")[3])
